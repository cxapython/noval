...
- **🌐 多内容类型支持** - 支持小说、新闻、文章、博客等，自动适配字段名称（v6.0.0 NEW! ⭐）
- **🎯 可视化元素选择器** - 在真实页面上点击元素，自动生成智能XPath，效率提升6-9倍！（v5.0.0）
- **🤖 智能XPath生成** - 7种生成策略，置信度高达98%，避免动态内容（v5.0.0）
...
![我的书架列表](images/我的书架列表.png)

*现代化书架界面，支持编辑和删除*

![小说阅读器配置](images/小说阅读器配置.png)
