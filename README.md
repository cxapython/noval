...
**功能**:
- ✅ **🧙 智能向导** - 可视化识别页面元素，自动生成配置（v2.0.1 NEW!）
...
### 当前版本：v3.1.0 (2025-10-05)

#### 🚀 核心功能
- 🎯 **任务管理系统** - WebSocket实时进度追踪，可视化任务监控
- 🧙 **智能配置向导** - 页面元素识别，自动生成XPath配置
- 🕷️ **可视化爬虫配置** - 无需编码，界面配置解析规则
- 📖 **现代化阅读器** - 5种主题，翻页/滚动双模式
- 🏗️ **SQLAlchemy 2.0** - ORM架构，连接池管理
- 🔄 **智能文字替换** - 正则支持，预览高亮，批量替换
- 📝 **小说信息管理** - 编辑标题/作者/封面，级联删除
